...
%added
leg11 = line('Parent',h_axes,'Color',color2,'Visible','off','LineWidth',4);
leg12 = line('Parent',h_axes,'Color',color2,'Visible','off','LineWidth',4);
leg21 = line('Parent',h_axes,'Color',color2,'Visible','off','LineWidth',4);
leg22 = line('Parent',h_axes,'Color',color2,'Visible','off','LineWidth',4);
